  ...
  tabs: {
    Brands: {
      ...
      columns: [
        ...
        {key: 'next_action_date', header: 'Next Action Date', type: 'date', width: 110},
    ...
    Templates: {
      frozen_rows: 1,
      columns: [
        {key: 'stage', header: 'Stage', type: 'text', width: 120},
        {key: 'day_offset', header: 'Day Offset', type: 'number', width: 100},
        {key: 'user_prompt', header: 'User Prompt Template', type: 'text', width: 500}
      ],
      default_rows: [
    ...
    Dashboard: {
      ...
      default_rows: [
        ['Total sent (all time)', '=COUNTIF(Brands!O:O,">=1")'],
