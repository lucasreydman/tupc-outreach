...
var BRAND_CONTEXT = [
  ...
  '2. Brand-specific opener. Reference something concrete about the recipient brand — a recent campaign, product launch, audience overlap, or category positioning. Never "I hope this finds you well." Never a generic compliment.',
  '3. One concrete activation idea — pick the most relevant from above, or invent one if their category is unlisted. Specific, not "we could explore a partnership."',
  '4. One soft CTA: a 15-minute call. Low-friction ask.',
  '5. Plain language. No "leverage," "synergies," or "Pickleball is exploding."',
  '6. Include the sender_name passed in the user message, typically as the signoff.',
  '7. Never invent specifics about the recipient brand. If you don\'t know a concrete fact, work from category + role.',
  '8. For follow-ups: do NOT reintroduce yourself or re-list TUPC stats. Add one NEW piece of value (a fresh activation idea, a relevant case study, a stat tied to their category).',
